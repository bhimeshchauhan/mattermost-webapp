...
export default class EmojiPicker extends React.PureComponent {
    ...
    constructor(props) {
        ...
        const activeCategory = props.recentEmojis.length ? 'recent' : 'smileys-emotion';
        this.state = {
            allEmojis: {},
            categories,
    ...
    handleCategoryClick = (categoryName) => {
        ...
        // implement to know the index of the category
        this.resultsListRef?.current?.scrollToItem(213, 'start');
    }
        ...
        return (
            ...
            >
                ...
                <EmojiPickerCategories
                    ...
                    selectNextEmoji={this.selectNextEmoji}
                    selectPrevEmoji={this.selectPrevEmoji}
                    focusOnSearchInput={this.focusOnSearchInput}
                />
                <EmojiPickerCurrentResults
                    ref={this.resultsListRef}
                    filter={this.props.filter}
